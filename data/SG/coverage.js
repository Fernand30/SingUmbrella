export default (coverageItems = {
  ...
  unlimitedEmergencyMedicalEvacuation: {
    ...
    icon: "emergency_medical_evacuation"
  },
  overseasMedicalExpenses: {
    title: "Overseas medical expenses",
    icon: "overseas_medical_expenses",
    description:
  ...
  overseasCashBenefit: {
    ...
    icon: "overseas_medical_reimbursement",
    description:
  ...
  overseasAccidentalDeath: {
    title: "Accidental Death",
    icon: "overseas_accidental_death",
    description:
  ...
  overseasPermanentDisablement: {
    title: "Permanent Disablement",
    icon: "overseas_permanent_disablement",
    description:
  ...
  dishonest: {
    title: "Dishonest and Criminal",
    icon: "dishonest",
    description:
      "Any fraudulent, dishonest, malicious or inentional criminal conduct by you or people related to you."
  },
  war: {
  ...
  seizure: {
    ...
    icon: "seizure",
    description:
      "Any consequence of government or public or local authority action and or policy."
  },
  Wear: {
    title: "Wear and Tear",
    icon: "Wear",
    description:
      "Any form of deterioration leading to maifunction."
  },
});
